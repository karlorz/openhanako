...
PR #4 was integrated into `dev` on 2026-08-09 by an ancestry-preserving normal merge commit `ba988d1b3990bd9a739f79ff9b2b0126935fcf4c` (final feature head `9f2c3ffd4fad67431572c9e2e5cb87af278c14e3`). Published fork prerelease tags `v0.421.24-karlorz.3` through `.5` remain ancestors of `dev`; no squash or rebase was used. No `sg01` deployment or restart occurred.
