...
| plugin-iframe-remote-credential-query-leak | upstream | draft/pending-approval | [#1493](https://github.com/liliMozi/openhanako/issues/1493) OPEN, [#2367](https://github.com/liliMozi/openhanako/issues/2367) OPEN, [#1546](https://github.com/liliMozi/openhanako/issues/1546) CLOSED | fold into LAN query-token/auth bug fix unless reviewed separately |
