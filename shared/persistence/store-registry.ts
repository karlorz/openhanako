...
export const PERSISTENT_STORES: readonly StoreDescriptor[] = Object.freeze([
  ...
  defineStore({
    ...
    pathPatterns: [
      ...
      "plugin-marketplace-claude-skills/{marketplaceId}/{pluginId}.json",
      "claude-compatibility/{mode}/{bindingId}.json",
      "plugin-trust.json",
    ],
    pathKind: "tree",
    format: "mixed-directory",
    schemaSource: directorySource("core/plugin-manager.ts", "installed manifest, install receipt, backup, multi-source artifacts, marketplace registry, Claude skill provenance, and compatibility-state protocols"),
