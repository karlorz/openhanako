...
- PR #1 remains OPEN, draft, `dev` → `main`, and without auto-merge; it was not used as a merge or release vehicle. The plain upstream `v0.421.24` tag was never pushed to the fork. sg01 remains unchanged on `v0.416.51-karlorz.8` / `8345b01a9fabac590bb35ccaac0a2c9ec0a2ce19`; no host deployment, upgrade, or service mutation was performed.
...
| Published fork release | `v0.421.24-karlorz.2` @ `adc36cd6` (`legacy-raw`, verified GitHub prerelease) |
