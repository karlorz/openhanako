...
Compact config for dev-loop v1.26.22. The operating guide remains in
...
notes:
  ...
  tag_namespace_rule: "Plain v{version} tags belong to upstream sync targets; fork release tags use the -karlorz.N suffix. Latest verified fork tag: v0.416.51-karlorz.1."
  current_prerelease_sync: "2026-07-25: after stable v0.416.44, dev rebased all 220 fork commits onto train-beta-17 / v0.416.51 at ef8a6f70 with explicit double consent. Package/lock/digests align to 0.416.51; full and focused gates passed; local signed 0.416.51 installed/codesigned; helper and image upload/preview/chat-switch smoke passed. Fork releases v0.416.44-karlorz.1 and v0.416.51-karlorz.1 were published and independently verified; sg01 was not deployed and remains on v0.416.43-karlorz.1."
  ...
  server_deploy_policy: "Attended only through scripts/install-server.mjs and docs/server-install.md: verify release assets, run --channel prerelease dry-run before execute, and never recreate the retired SSH deploy helper."
  remote_assessment_policy: "Attended read-only evidence lives at .claude/remote-assessment/latest.json (30-minute TTL); use the smoke helper and offline check-remote-prerequisites.mjs flow documented in CONTEXT.md."
  ...
  latest_fork_release: "v0.416.51-karlorz.1 at ac3c2e7924fb4daa8d6b2fc086fb619022e4779a; GitHub prerelease profile legacy-raw; 20 release assets, digest/profile/compatibility identity, local signed desktop install, and manual preview/chat-switch smoke verified 2026-07-25. sg01 intentionally remains on v0.416.43-karlorz.1."
  next_stable_sync_observed: "Stable v0.416.44 was synchronized first on 2026-07-25. After the separate train-beta-17 / v0.416.51 prerelease sync, no newer non-prerelease was available; future default detection remains stable-only."
