...
release_policy:
  ...
  latest_verified_fork_tag: v0.346.18-karlorz.2
...
server_deploy:
  ...
  current_verified_target: v0.346.18-karlorz.2
  install_server:
  ...
  policy:
    ...
    - "Use --channel prerelease for fork tags such as v0.346.18-karlorz.1."
